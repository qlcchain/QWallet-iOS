...
public final class TezosAddress: Address {
    ...
    public static func deriveOriginatedAddress(operationHash: String, operationIndex: Int32) -> String {
        let operationHashString = TWStringCreateWithNSString(operationHash)
        defer {
            TWStringDelete(operationHashString)
        }
        return TWStringNSString(TWTezosAddressDeriveOriginatedAddress(operationHashString, Int32(operationIndex)))
    }
