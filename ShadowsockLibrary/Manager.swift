...
extension Manager {
    ...
    fileprivate func loadAndCreateProviderManager(_ complete: @escaping (NETunnelProviderManager?, Error?) -> Void ) {
        NETunnelProviderManager.loadAllFromPreferences { [unowned self] (managers, error) -> Void in
            if let managers = managers {
                ...
                manager.localizedDescription = Manager.appName
                manager.protocolConfiguration?.serverAddress = Manager.appName
    ...
    fileprivate func createProviderManager() -> NETunnelProviderManager {
        ...
        protocolConfiguration.providerBundleIdentifier = ShadowsockTunnelBundleID
        manager.protocolConfiguration = protocolConfiguration
        return manager
    }
    
    public static var appName: String {
        return SHADOWSOCK_VPN
