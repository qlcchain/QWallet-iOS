 ...
 * 请求VPN配置文件列表
 */
static NSString *sendVpnFileListReq = @"sendVpnFileListReq";
/**
 * 请求VPN配置文件列表响应
 */
static NSString *sendVpnFileListRsp = @"sendVpnFileListRsp";
/**
 * 请求VPN配置文件
 */
static NSString *sendVpnFileNewReq = @"sendVpnFileNewReq";
/**
 * 请求VPN配置文件响应
 */
static NSString *sendVpnFileNewRsp = @"sendVpnFileNewRsp";
/**
 * 注册成功后通知SERVER vpn用户名、密码、私钥
 */
static NSString *vpnRegisterSuccessNotify = @"vpnRegisterSuccessNotify";
