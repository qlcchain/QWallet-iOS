...
@property (nonatomic, copy) NSString * _Nullable heroNavigationAnimationTypeString SWIFT_DEPRECATED_MSG("Use hero.navigationAnimationTypeString instead");
@end
...
@property (nonatomic, copy) NSString * _Nullable heroID SWIFT_DEPRECATED_MSG("Use hero.id instead");
@property (nonatomic) BOOL isHeroEnabled SWIFT_DEPRECATED_MSG("Use hero.isEnabled instead");
@property (nonatomic) BOOL isHeroEnabledForSubviews SWIFT_DEPRECATED_MSG("Use hero.isEnabledForSubviews instead");
@property (nonatomic, copy) NSString * _Nullable heroModifierString SWIFT_DEPRECATED_MSG("Use hero.modifierString instead");
@end
...
@interface UIViewController (SWIFT_EXTENSION(Hero))
@property (nonatomic, copy) NSString * _Nullable heroModalAnimationTypeString SWIFT_DEPRECATED_MSG("Use hero.modalAnimationTypeString instead");
@property (nonatomic) BOOL isHeroEnabled SWIFT_DEPRECATED_MSG("Use hero.isEnabled instead");
@end
