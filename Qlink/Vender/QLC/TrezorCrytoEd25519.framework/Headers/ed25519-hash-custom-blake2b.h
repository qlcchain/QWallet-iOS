...
#ifndef ed25519_hash_custom_blake2b_h
#define ed25519_hash_custom_blake2b_h
...
#define ed25519_hash(hash, in, inlen) blake2b_qlc((in), (inlen), (hash), 64)

#endif /* ed25519_hash_custom_blake2b_h */
