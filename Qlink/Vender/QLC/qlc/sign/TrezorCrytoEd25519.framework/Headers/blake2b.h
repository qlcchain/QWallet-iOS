...
int blake2b_qlc(const uint8_t *msg, uint32_t msg_len, void *out, size_t outlen);
int blake2b_Key_qlc(const uint8_t *msg, uint32_t msg_len, const void *key, size_t keylen, void *out, size_t outlen);
