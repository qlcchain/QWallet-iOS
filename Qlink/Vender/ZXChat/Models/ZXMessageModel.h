...
#define MessageTextLab_FontSize 14.0
#define MessageNameLab_FontSize 11.0
#define MessageTimeLab_FontSize 10.0
...
@property (nonatomic, assign) CGSize messageTextSize;                   // 消息大小
@property (nonatomic, assign) CGSize messageNameSize;
@property (nonatomic, assign) CGSize messageTimeSize;
