...
- (void) layoutSubviews
{
    ...
    if (self.messageModel.ownerTyper == ZXMessageOwnerTypeSelf) {
        ...
        [self.messageBackgroundImageView setFrame:CGRectMake(x, y, self.messageModel.messageTextSize.width+ 10, self.messageModel.messageTextSize.height + 10)];
    }
...
-(void)setMessageModel:(ZXMessageModel *)messageModel
{
    ...
    if(messageModel.imagePath != nil) {
        ...
        [self.messageImageView setSize:CGSizeMake(messageModel.messageTextSize.width + 10, messageModel.messageTextSize.height + 10)];
    }
