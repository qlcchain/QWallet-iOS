...
@property (nonatomic, strong) UIButton *sendButton;  // 聊天发送按钮
...
-(void)setFrame:(CGRect)frame
{
    ...
    float y = self.frameHeight - self.voiceButton.frameHeight - (HEIGHT_CHATBOX - CHATBOX_BUTTON_WIDTH) / 2;
    if (self.voiceButton.originY != y) {
        [UIView animateWithDuration:0.1 animations:^{
            ...
            [self.sendButton setOriginY:self.voiceButton.originY];
        }];
    }
}
...
- (BOOL) resignFirstResponder
{
    ...
    [_sendButton setImage:[UIImage imageNamed:@"button_send"] forState:UIControlStateNormal];
    [_sendButton setImage:[UIImage imageNamed:@"button_send"] forState:UIControlStateHighlighted];
...
- (void) textViewDidChange:(UITextView *)textView
{
    ...
    _curHeight = height + HEIGHT_CHATBOX - HEIGHT_TEXTVIEW;
...
{
    if (_voiceButton == nil) {
        _voiceButton = [[UIButton alloc] initWithFrame:CGRectMake(0, (HEIGHT_CHATBOX - CHATBOX_BUTTON_WIDTH) / 2, 0, CHATBOX_BUTTON_WIDTH)];
//        _voiceButton = [[UIButton alloc] initWithFrame:CGRectMake(0, (HEIGHT_CHATBOX - CHATBOX_BUTTON_WIDTH) / 2, CHATBOX_BUTTON_WIDTH, CHATBOX_BUTTON_WIDTH)];
        [_voiceButton setImage:[UIImage imageNamed:@"ToolViewInputVoice"] forState:UIControlStateNormal];
        [_voiceButton setImage:[UIImage imageNamed:@"ToolViewInputVoiceHL"] forState:UIControlStateHighlighted];
...
//        _textView.frame = CGRectMake(4, self.frameHeight * 0.13, self.sendButton.originX - self.sendButton.frameWidth - 8, HEIGHT_TEXTVIEW);
        _textView.frame = CGRectMake(8, (HEIGHT_CHATBOX - HEIGHT_TEXTVIEW)/2.0, self.sendButton.originX - 12, HEIGHT_TEXTVIEW);
//        [_textView addPlaceHolder:@"Type a message..."];
        [_textView setFont:[UIFont fontWithName:@"Roboto-Regular" size:15.0]];
...
{
    if (_faceButton == nil) {
        _faceButton = [[UIButton alloc] initWithFrame:CGRectMake(self.sendButton.originX - CHATBOX_BUTTON_WIDTH, (HEIGHT_CHATBOX - CHATBOX_BUTTON_WIDTH) / 2, CHATBOX_BUTTON_WIDTH, CHATBOX_BUTTON_WIDTH)];
//        _faceButton = [[UIButton alloc] initWithFrame:CGRectMake(self.moreButton.originX - CHATBOX_BUTTON_WIDTH, (HEIGHT_CHATBOX - CHATBOX_BUTTON_WIDTH) / 2, CHATBOX_BUTTON_WIDTH, CHATBOX_BUTTON_WIDTH)];
        [_faceButton setImage:[UIImage imageNamed:@"ToolViewEmotion"] forState:UIControlStateNormal];
        [_faceButton setImage:[UIImage imageNamed:@"ToolViewEmotionHL"] forState:UIControlStateHighlighted];
...
{
    if (_moreButton == nil) {
        _moreButton = [[UIButton alloc] initWithFrame:CGRectMake(WIDTH_SCREEN, (HEIGHT_CHATBOX - CHATBOX_BUTTON_WIDTH) / 2, 0, CHATBOX_BUTTON_WIDTH)];
//        _moreButton = [[UIButton alloc] initWithFrame:CGRectMake(WIDTH_SCREEN - CHATBOX_BUTTON_WIDTH, (HEIGHT_CHATBOX - CHATBOX_BUTTON_WIDTH) / 2, CHATBOX_BUTTON_WIDTH, CHATBOX_BUTTON_WIDTH)];
        [_moreButton setImage:[UIImage imageNamed:@"TypeSelectorBtn_Black"] forState:UIControlStateNormal];
        [_moreButton setImage:[UIImage imageNamed:@"TypeSelectorBtnHL_Black"] forState:UIControlStateHighlighted];
...
- (UIButton *)sendButton {
    if (!_sendButton) {
        _sendButton = [[UIButton alloc] initWithFrame:CGRectMake(WIDTH_SCREEN - CHATBOX_BUTTON_WIDTH - 4, (HEIGHT_CHATBOX - CHATBOX_BUTTON_WIDTH) / 2, CHATBOX_BUTTON_WIDTH, CHATBOX_BUTTON_WIDTH)];
        [_sendButton setImage:[UIImage imageNamed:@"button_send"] forState:UIControlStateNormal];
        [_sendButton setImage:[UIImage imageNamed:@"button_send"] forState:UIControlStateHighlighted];
