...
enum ButtonStyle: Int {
    ...
    var backgroundColor: UIColor {
        switch self {
        case .solid, .squared: return UIColor.gray
    ...
    var backgroundColorHighlighted: UIColor {
        switch self {
        case .solid, .squared: return UIColor.gray
        case .border: return UIColor.gray
    ...
    var textColor: UIColor {
        switch self {
        case .solid, .squared: return UIColor.gray
        case .border, .borderless: return UIColor.gray
        }
    }
    ...
    var textColorHighlighted: UIColor {
        ...
        case .border: return UIColor.gray
        case .borderless: return UIColor.gray
        }
    }

    var borderColor: UIColor {
        switch self {
        case .solid, .squared, .border: return UIColor.lightGray
