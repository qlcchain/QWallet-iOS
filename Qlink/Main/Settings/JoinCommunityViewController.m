...
- (void)viewDidLoad {
    ...
    [_sourceArr addObjectsFromArray:@[@[@"icon_twitter_url",@"Twitter @playblockz",@"twitter.com/QLCchain"],@[@"icon_telegram_url",@"Telegram",@"t.me/qlinkmobile"],@[@"icon_facebook_url",@"Facebook",@"www.facebook.com/QLCchain/"],@[@"icon_winq_url",@"WINQ Website",@"qlcchain.org/"]]];
