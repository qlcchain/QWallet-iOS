...
@implementation QLCTransferConfirmView

+ (instancetype)getInstance {
    QLCTransferConfirmView *view = [[[NSBundle mainBundle] loadNibNamed:@"QLCTransferConfirmView" owner:self options:nil] lastObject];
