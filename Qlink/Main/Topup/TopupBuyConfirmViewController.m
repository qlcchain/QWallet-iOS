...
@implementation TopupBuyConfirmViewController
...
//    NSString *desStr = [NSString stringWithFormat:@"%@%@%@",countryStr,provinceStr,ispStr];
    ...
    NSString *deduction1Str = _inputProductM.payFiatAmount.mul(_inputProductM.qgasDiscount);
    ...
    NSString *deductionAmountStr = [_inputProductM.payFiatAmount.mul(_inputProductM.qgasDiscount).div(deductionTokenPrice) showfloatStr:3];
    ...
    _productPriceLab.text = [NSString stringWithFormat:@"%@%@+%@%@",payAmountStr,_inputProductM.payTokenSymbol,deductionAmountStr,_inputDeductionTokenM.symbol];
