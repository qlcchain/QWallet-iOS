...
- (BOOL) isWalletAddress
{
    NSString *addressRegex =@"^A([A-Za-z0-9]{33})";
    return [self isValidateByRegex:addressRegex];
}
// vpn文件名
- (BOOL) isVPNFileName
{
    NSString *fileNameRegex =@"[A-Za-z0-9]*";
    return [self isValidateByRegex:fileNameRegex];
}
